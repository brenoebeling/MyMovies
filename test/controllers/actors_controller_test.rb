...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { birthdate: @actor.birthdate, country: @actor.country, gender: @actor.gender, name: @actor.name } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { birthdate: @actor.birthdate, country: @actor.country, gender: @actor.gender, name: @actor.name } }
